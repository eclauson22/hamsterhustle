...
public class ObstacleGenerator : MonoBehaviour
{
    ...
    void GenerateObstacle()
    {
        ...
        int randomOffset = Random.Range(-2, 4); //choose between -1, 0, and 1, for three lanes instead of any float in between -1 and 1. used to also be between -5 and 5
        ...
        Debug.Log("Obstacle spawned in lane: " + randomOffset);
    }
